...
public class HomeController : Controller
{
    ...
    static List <CountriesID> CreateCountrysList(){
        ...
        new CountriesID {countryName="Denmark",capitalCountry="Copenhagen",urlImagen="",urlCityImage="Content/Images/countries/",id=2618425},
        new CountriesID {countryName="Estonia",capitalCountry="Tallinn",urlImagen="",urlCityImage="Content/Images/countries/",id=588409},
        new CountriesID {countryName="Finland",capitalCountry="Helsinki",urlImagen="",urlCityImage="Content/Images/countries/",id=658225},
        new CountriesID {countryName="France",capitalCountry="Paris",urlImagen="",urlCityImage="Content/Images/countries/",id=2988507},
        new CountriesID {countryName="Georgia",capitalCountry="Tbilisi",urlImagen="",urlCityImage="Content/Images/countries/",id=611717},
        new CountriesID {countryName="Greece",capitalCountry="Athens",urlImagen="",urlCityImage="Content/Images/countries/",id=264371},
        new CountriesID {countryName="Hungary",capitalCountry="Budapest",urlImagen="",urlCityImage="Content/Images/countries/",id=3054643},
        new CountriesID {countryName="Iceland",capitalCountry="Reykjavik",urlImagen="",urlCityImage="Content/Images/countries/",id=3413829},
        new CountriesID {countryName="Ireland",capitalCountry="Dublin",urlImagen="",urlCityImage="Content/Images/countries/",id=2964574},
        new CountriesID {countryName="Italy",capitalCountry="Rome",urlImagen="",urlCityImage="Content/Images/countries/",id=3169070},
        new CountriesID {countryName="Kazakhstan",capitalCountry="Astana",urlImagen="",urlCityImage="Content/Images/countries/",id=1526273},
        new CountriesID {countryName="Kosovo",capitalCountry="Pristina",urlImagen="",urlCityImage="Content/Images/countries/",id=786714},
        new CountriesID {countryName="Latvia",capitalCountry="Riga",urlImagen="",urlCityImage="Content/Images/countries/",id=456172},
